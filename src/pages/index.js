...
const features = [
  {
    ...
    description: (
      <>
        ...
        . It displays overviews and breakdowns of key performance metrics such
        as training throughput and memory usage.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        No more performance surprises! Skyline transparently profiles your model
        in the background as you make changes during development. You'll be the
        first to know when changes to your model affect its computational
        performance.
      </>
    ),
  },
          ...
          <div className={clsx("col col--6", styles.heroText)}>
            ...
            <div className="row">
              <div className="col col--12 hero--button--row">
                ...
                {/* NOTE: Remove <Link> block below to remove 'Code' button */}
                {/* You can change the link: ` to={useBaseUrl("docs/")} `   */}
                {/* To have it point to the documentation if you have those */}
                {/* enabled in the docsdocusaurus.config.js file */}
                
                <Link
                  className="button button--secondary button--lg hero--button"
                  to={"https://github.com/skylineprof/skyline/"}
                >
                  Code
                </Link>
